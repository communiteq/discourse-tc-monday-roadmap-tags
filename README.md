There are four special tags and they belong to a tag group which can only be set by staff (if you have another group for that, that will work too), and only one at a time.
